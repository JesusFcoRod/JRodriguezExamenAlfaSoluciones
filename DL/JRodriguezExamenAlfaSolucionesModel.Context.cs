...
namespace DL
{
    ...
    public partial class JRodriguezExamenAlfaSolucionesEntities : DbContext
    {
        public JRodriguezExamenAlfaSolucionesEntities()
            : base("name=JRodriguezExamenAlfaSolucionesEntities")
        {
        }
